...
// UnimplementedFatimaMessageServiceServer can be embedded to have forward compatible implementations.
...
func RegisterFatimaMessageServiceServer(s *grpc.Server, srv FatimaMessageServiceServer) {
	s.RegisterService(&_FatimaMessageService_serviceDesc, srv)
}
